...
const EditionOffersTable = ({editionAddress, refresh, setRefresh, deleteOfferCB, placeOfferCB}) => {
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            query{
                offers(where:{offerer: "${signer.address.toLowerCase()}", editionId: "${editionAddress}"}, orderBy:offerPrice, orderDirection:desc){
                    copyUid
                    offerPrice
                }
            }`);
            setPlacedOffers(placedOffers.offers);
            setSelectedCopyUid();
            setLoading(false);
        };
        getData();
                        ...
                        {!editionOffers.length > 0 ? (
                            ...
                            <div className="flex w-full flex-col">
                                <div className="flex w-full justify-between">
                                    <button
                                        className={`w-full cursor-pointer rounded-tl py-3 px-8 text-center text-sm focus:outline-none ${
                                            showPlacedOffers
                                                ...
                                                : "bg-gray-600 font-semibold tracking-wider text-white duration-200 hover:bg-gray-600"
                                        }`}
                                        onClick={() => {
                                    ...
                                    <button
                                        className={`w-full cursor-pointer rounded-tr py-3 px-8 text-center text-sm focus:outline-none ${
                                            showPlacedOffers
                                                ? "bg-gray-600 font-semibold tracking-wider text-white duration-200 hover:bg-gray-600"
                                                : "bg-gray-100 font-medium text-gray-400 hover:bg-gray-200 active:scale-95"
                                        }`}
                                    ...
                                    <>
                                        {placedOffers.length > 0 ? (
                                            <div className="h-full min-w-full px-5 py-2.5">
                                                <div className="my-4">
                                                    <button
                                                        className="button-os w-[45%] bg-gray-600 px-3 py-2.5 text-white hover:bg-gray-600 focus:bg-gray-600"
                                                        onClick={async () => {
                                                            if (selectedCopyUid) {
                                                                await cancelOffer(
                                                                    signer.signer,
                                                    ...
                                                    <table className="min-w-full table-fixed divide-y divide-gray-200 rounded">
                                                        <thead className="overscroll-none rounded bg-gray-300">
                                                            <tr>
                                                                ...
                                                                <th
                                                                    scope="col"
                                                                    className="py-2 pl-4 text-center text-xs font-semibold tracking-wider text-gray-700">
                                                                    Copy ID
                                                                </th>
                                                                <th
                                                                    scope="col"
                                                            ...
                                                            {placedOffers.map((offer, index) => {
                                                                return (
                                                                    <tr
                                                                        ...
                                                                        <td className="break-all py-2 px-4 text-center font-mono text-sm font-medium text-gray-900">
                                                                            {offer.copyUid}
                                                                        </td>
                                            ...
                                            <div className="m-auto text-lg font-medium">
                                                No Offers Placed for this Book.
                                            </div>
                                        )}
                                    </>
                                ) : (
                                        ...
                                        <div className="my-4">
                                            <div className="flex items-center justify-between space-x-3">
                                                <div className="flex w-full justify-between space-x-3">
                                                    ...
                                                    />
                                                    <button
                                                        className="button-os w-[45%] bg-gray-600 px-3 text-white hover:bg-gray-600 focus:bg-gray-600"
                                                        onClick={async () => {
                                                            setOfferReq(true);
                                                            if (
