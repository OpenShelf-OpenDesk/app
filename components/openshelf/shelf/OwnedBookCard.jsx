...
const OwnedBookCard = ({editionId, copyUid, owner}) => {
    ...
    return (
        <div className="relative">
            <div
                className={`group h-[300px] snap-start rounded bg-transparent transition duration-500 ease-in-out ${
                            ...
                            <div className="h-full w-60">
                                <div className="flex h-full flex-col justify-center p-3 text-gray-700">
                                    <p className="break-all font-semibold leading-tight">
                                        {copy.edition.editionMetadata.title.length > 45
                                    ...
                                    <p className="mt-3 break-all text-justify text-sm font-medium leading-tight">
                                        {copy.edition.editionMetadata.description.length > 300
                                ...
                                <div className="flex h-full flex-col items-center justify-center space-y-3">
                                    <div className="flex w-full items-center justify-between">
                                        ...
                                        <div className="rounded py-0.5 font-mono text-base font-semibold">
                                            {new Date(
                                                parseInt(copy.purchasedOn) * 1000
                                            ...
                                            <button
                                                ...
                                                onClick={async () => {
                                                    ...
                                                    await putOnRent(
                                                        ...
                                                        copyUid,
                                                        calculateFlowRate(
                                                            new BigNumber(newFlowRate).shiftedBy(
                                                                -18
                                                            )
                                                        )
                                                    );
