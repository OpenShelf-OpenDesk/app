        ...
        <div className="w-full text-sm">
            <Listbox value={selected} onChange={setSelected}>
                <div className="relative w-full">
                    <Listbox.Button className="flex w-full flex-row items-center justify-between gap-x-5 rounded border-2 border-gray-300 py-2 px-3 font-medium focus-within:border-blue-300 focus-within:shadow focus-within:shadow-blue-300/50 focus-within:outline-none focus-within:ring-0 hover:border-blue-300 hover:shadow hover:shadow-blue-300/50">
                        <span>{selected}</span>
